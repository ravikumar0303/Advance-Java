...
public class ProductDaoImp implements ProductDao {
	...
	private static PreparedStatement psgetall,psadd,psgetbyid,psupdate;
	...
	static {
		...
		try {
			...
			psupdate=conn.prepareStatement("update product set qut=?,price=?,pname=?");
	...
	@Override
	public Product findByI(int pid) {
		try {
